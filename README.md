...
The score calculator is complete and functional. It was a real challenge to make this work, since the bowling score system is kind of weird. I was able to make it work with some random games, low ones and high ones.
Future updates of this will be more user-friendly, with some CSS styling and logging the scores to the actual website instead of just the console.
